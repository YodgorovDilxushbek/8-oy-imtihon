...
function Card() {
    return (
        <div className='items-center justify-center '>
            ...
            <div className=" xl:mt-[72px] xl:ml-[252px] flex  gap-20 items-center  xl:gap-[267px] sm:gap-[81px]   sm:mt-[34px] justify-between ml-5    "  >
            <div className='sm:ml-[48px]'>
                <h3 className="text-[22px] md:text-[32px] font-bold  md:pl-[48px]  sm:pl-[48px] ">
                    Invoices
                </h3>
            ...
            <div className='flex justify-between sm:ml-[48-px] md:gap-[40px]  sm:mr-[48px] ml-3 '>
